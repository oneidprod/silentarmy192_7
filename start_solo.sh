...
#pooly
# POOL=stratum+tcp://pooly.ca:3050
# WALLET=t1TCgwxZ3RMpWtg3Tu5qk8BcNdawRHeJd1g.test
# PASS=x

#zeropool
# POOL=stratum+tcp://solo.zeropool.io:4241
# WALLET=t1TCgwxZ3RMpWtg3Tu5qk8BcNdawRHeJd1g.test
# PASS=x
